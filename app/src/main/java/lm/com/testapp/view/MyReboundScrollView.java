...
public class MyReboundScrollView extends ScrollView {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (shouldMove) {
                    ...
                    if (dropDownListener != null){
                        dropDownListener.dropDown(offset);
                    }
                }
    ...
    public interface IDropDownListener{
         ...
         * @param offset 下拉偏移量
         */
        void dropDown(int offset);
        void dropDownEnd();
    }

    public void setDropDownListener(IDropDownListener dropDownListener) {
